...
fun BarcodePreviewScreen(
    ...
    Scaffold(
        ...
        BarcodeItemsPreview(
            Modifier.padding(paddingValues).fillMaxSize(), parsedResult.items.map { it.barcode })
    }
}

@Composable
fun BarcodeItemsPreview(modifier: Modifier = Modifier, items: List<BarcodeItem>) {
    LazyColumn(
        modifier = modifier,
